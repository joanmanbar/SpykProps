...
def SpikesDF(I, ImagePath):
    ...
    EquivDiams = [rp.equivalent_diameter_area for rp in props_spikes]
    Extents = [rp.extent for rp in props_spikes]
    Ferets = [rp.feret_diameter_max for rp in props_spikes]
    InertiaTensors = [rp.inertia_tensor for rp in props_spikes]
    PerimCroftons = [rp.perimeter_crofton for rp in props_spikes]
    Soliditys = [rp.solidity for rp in props_spikes]
    ...
    list(zip(Image_Name, Labels,
             ...
             S_Perc[:,0], S_Perc[:,1], S_Perc[:,2], S_Perc[:,3], S_Perc[:,4], S_Perc[:,5], S_Perc[:,6],
             V_Perc[:,0], V_Perc[:,1], V_Perc[:,2], V_Perc[:,3], V_Perc[:,4], V_Perc[:,5], V_Perc[:,6],
             Areas, MajorAxes, MinorAxes, Orientations, Eccentricities,Perimeters,EquivDiams,Extents,Ferets,InertiaTensors,PerimCroftons,Soliditys)),
    columns = ['Image_Name', 'Spike_Label',
               'Red_mean', 'Red_min', 'Red_max', 'Green_mean', 'Green_min', 'Green_max', 'Blue_mean', 'Blue_min', 'Blue_max',
               'L_mean', 'L_min', 'L_max', 'a_mean', 'a_min', 'a_max', 'b_mean', 'b_min', 'b_max',
               'H_mean', 'H_min', 'H_max', 'S_mean', 'S_min', 'S_max', 'V_mean', 'V_min', 'V_max',
               'Red_p25', 'Red_p50', 'Red_p75', 'Red_Mean', 'Red_sd', 'Red_Min', 'Red_Max',
               ...
               'S_p25', 'S_p50', 'S_p75', 'S_Mean', 'S_sd', 'S_Min', 'S_Max',
               'V_p25', 'V_p50', 'V_p75', 'V_Mean', 'V_sd', 'V_Min', 'V_Max',
               'Area', 'MajorAxis', 'MinorAxes', 'Orientation', 'Eccentricity', 'Perimeter','EquivDiams','Extents','Ferets','InertiaTensors','PerimCroftons','Soliditys'])
    ...
    # Cols.insert(14, Cols.pop(Cols.index('Circularity')))
